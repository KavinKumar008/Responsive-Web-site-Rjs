  ...
  return (
    <div className='about'>
       ...
       <div className="about-right">
        ...
        <p>With a focus on innovation, hands-on learning, and personalized mentorship, our programs prepare aspiring educators
          to make a meaningful impact in classrooms, schools and cmmunuties.</p>
          <p>Whether to aspire to become a teacher, administrator, counselor, or educational leader, out diverse range of programs
